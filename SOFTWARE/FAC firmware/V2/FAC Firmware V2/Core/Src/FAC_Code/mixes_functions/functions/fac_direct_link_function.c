/*
 * fac_direct_link_function.c		// 1) of HOW TO MAKE A MIX
 *
 ...
 *		In case this new function can be used multiple times, add it multiple times on the FAC_SPECIAL_FUNCTIONS_ID
 *		and add a suffix 1ST, 2ND ecc.
 *		(ex: FAC_SPECIAL_FUNCTION_DIRECT_LINK_TO_CHANNEL_1ST,
 *		FAC_SPECIAL_FUNCTION_DIRECT_LINK_TO_CHANNEL_2ND,...)
...
#include "FAC_Code/mixes_functions/functions/fac_direct_link_function.h"		// 2) of HOW TO MAKE A SPECIAL FUNCTION
...
/*
 * DESCRIPTION:
 * This function connect directly the output of a channel (input) to the output
 *
 * INPUTs DESCRIPTION:
 * A channel from the receiver
 *
 * OUTPUTs DESCRIPTION:
 * !! REMEMBER:
